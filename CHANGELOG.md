...
## [2.1.0](https://github.com/duytran1406/flasharr/compare/v2.0.0...v2.1.0) (2026-05-22)
...
* **indexer:** filter Newznab results by Sonarr/Radarr quality profile ([664a652](https://github.com/duytran1406/flasharr/commit/664a652b38813d13c3360879521694bead6a23d7))
...
* arr integration bugs T02-T06 ([7d65eb0](https://github.com/duytran1406/flasharr/commit/7d65eb09ccdd3a56e3c22254347a123ac3ad626f))
* arr integration bugs T02-T06 ([79fbd67](https://github.com/duytran1406/flasharr/commit/79fbd6755ab688d05a5039460ab8c08d76bdea62))
* **arr:** use RescanSeries/RescanMovie after library file move ([944d167](https://github.com/duytran1406/flasharr/commit/944d1673cbefcb750760ff64ade4ddc4c136891a))
* **arr:** use RescanSeries/RescanMovie after library file move ([cffc545](https://github.com/duytran1406/flasharr/commit/cffc545051afcd17370c26034af382bb1817857c))
* backend improvements from E2E testing ([26a2da4](https://github.com/duytran1406/flasharr/commit/26a2da4b0436e0d8bb96d2166a17e8b86c9c1317))
...
* **downloader:** propagate actual download path and add error visibility in arr sweep ([4e0bc95](https://github.com/duytran1406/flasharr/commit/4e0bc95251eacc082678e0aaf43b7c1f72169127))
...
* library normalization, bi-directional sync, and move logic ([bb5ef9c](https://github.com/duytran1406/flasharr/commit/bb5ef9c5ce99886e5648a33edc915364f9537821))
* library normalization, bi-directional sync, and move logic ([2844726](https://github.com/duytran1406/flasharr/commit/284472640316f9ed12f28cd3d4ede50281389bb1))
...
* **orchestrator:** resolve arr_announced stuck on 0 when media path not mounted ([a5250b0](https://github.com/duytran1406/flasharr/commit/a5250b0b7e1b38931b9d3131f64de15aceba163e))
...
* SABnzbd endpoint routing for both /sabnzbd and /sabnzbd/ paths ([e3b9902](https://github.com/duytran1406/flasharr/commit/e3b9902ee35cbb611387c2f36b2ea812a6bd7e3a))
* SABnzbd endpoint routing for both /sabnzbd and /sabnzbd/ paths ([4a1f8cf](https://github.com/duytran1406/flasharr/commit/4a1f8cf0473dd2857385e44d31525201f0892b0a))
* SABnzbd percentage type, async task manager, and import pipeline ([9fa75f7](https://github.com/duytran1406/flasharr/commit/9fa75f70e4113dd34e6a48ef72d608606a20fc41))
* SABnzbd percentage type, async task manager, and import pipeline ([68d0986](https://github.com/duytran1406/flasharr/commit/68d0986d1c1e9996f9fa2fbd5de34047d40c4480))
* **sabnzbd:** register /sabnzbd/api routes for arr health checks ([a008521](https://github.com/duytran1406/flasharr/commit/a008521affefe7250d819694f7cca212f3ac09f7))
...
* **smart-tokenizer:** raise viet_sub quality score from 10 to 80 ([16a5d88](https://github.com/duytran1406/flasharr/commit/16a5d885aa26a991df37e477d17684ee6fdc97a4))
...
* **tests:** update timeout retry count assertion to match increased max_retries (10→20) ([c95c489](https://github.com/duytran1406/flasharr/commit/c95c489828728703ab04f6aab56f843b01dea6cc))
