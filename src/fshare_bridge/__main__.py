"""
Fshare-Arr Bridge - Main Entry Point
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Fshare-Arr Bridge")
    parser.add_argument(
        "--mode",
    ...
    logger.info(f"Starting Fshare-Arr Bridge in {args.mode} mode")
